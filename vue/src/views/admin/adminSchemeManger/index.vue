...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x6', show: true, align: 'left', key: 'name', name: '规划策划名称' }, 
      ...
      { width: 'w50x5', show: true, align: 'left', key: 'project_num', name: '项目数' },  
      { width: 'w50x5', show: true, align: 'left', key: 'task_num', name: '重点任务数' }, 
      { width: 'flex1', show: true, align: 'right', key: {upd: '编辑', del: '删除'}, name: '操作' },
    ],
    editFrom: [],
    addItem: {},
    model: 't_scheme_plan',
