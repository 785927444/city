...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'flex1', show: true, align: 'left', key: 'year', name: '年份' }, 
      { width: 'w50x4', show: true, align: 'center', key: 'unit', name: '指标值' }, 
      { width: 'w50x4', show: true, align: 'right', key: {add: '新增', upd: '编辑', del: '删除'}, name: '操作' },
    ],
    editFrom: [
      { required: true,  editshow: 'none', name: '上级',   key: 'parent_id', type: 'input' },
      { required: true,  editshow: true,   name: '年份',   key: 'year', type: 'input' },
      { required: true,  editshow: true,   name: '指标值', key: 'unit', type: 'input' },
