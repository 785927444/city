          ...
          <div class="flex-col ww100 bg-white p20">
            ...
            <div class="flex-sc ww100 mt12">
              <div class="flex-sc flex1 h36">
                ...
                <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="publicStore.active={...item}">
