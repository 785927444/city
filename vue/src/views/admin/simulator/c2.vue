<template>
  <div class="layout-col">
    ...
    <div v-else class="layout-col white-rgba50 rad8 p10">
      <div class="ww100 flex-bc p10">
        <div class="flex-sc">
          <span class="f15 fw">模拟器配置</span>
        </div>
        <div v-if="isNull(publicStore.active)" class="flex-ec flex1 h30">
          <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="state.list.push(Object.assign({}, simulator))">
          ...
          <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="init()">
            <i-ep-refresh class="f12 fw" /><span class="f14 ml5">刷新</span>
          </div>
        </div>
        <div v-if="!isNull(publicStore.active)" class="flex-ec flex1 h30">
          <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="publicStore.active = {}">
      ...
      <div class="flex-col ww100 flex1 overlay">
        <div class="flex-col ww100 mb20" v-for="(item, index) in state.list" :key="index">
          <div class="ww100 flex-bc plr12 ptb8 bge">
            ...
            <div class="flex-ec flex1 h36">
              <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="handleSubmit(item)">
                <i-ep-refresh class="f12 fw" /><span class="f14 ml5">保存</span>
              </div>
              <div class="rad4 ptb6 plr10 flex-cc cursor bgi1 white ml10" @click.stop="item.apis.push(Object.assign({}, apii))">
          ...
          <div v-show="item.show" class="flex-col hh100 ww100" v-for="(v, i) in item.apis" :key="i">
            <div class="flex-sc c4">
              <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc cursor" @click.stop="v.show=!v.show">
                <span class="pl20"></span>
                <i-ep-caretTop v-if="v.show" />
                <i-ep-caretBottom v-else />
                <span class="ml5">名称(选填)</span>
              </div>
              <div class="hh100 plr12 ptb14 bo-ce-1 flex4 flex-bc relative bg-white">
            ...
            <div class="flex-col ww100 flex1" v-show="v.show">
              <div class="flex-sc c4">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc"><span class="i12 mr2 pl32">*</span>地址</div>
              ...
              <div class="flex-sc c4">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc"><span class="i9 mr2 pl32">*</span>路径</div>
                <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bg-white flex-bc">
                  <input class="flex1" v-model.trim="v.path" placeholder="(例：/api/admin/index)" />
                </div>
              </div>
              <div class="flex-sc c4">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc"><span class="pl40"></span>状态</div>
                <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bg-white flex-bc">
                  <el-switch v-model="v.status" inline-prompt active-text="已启用" inactive-text="已禁用" />
                </div>
              </div>
              <div class="flex-sc c4">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc"><span class="pl40"></span>间隔</div>
                <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bg-white flex-bc">
              ...
              <div class="flex-sc c4">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-sc"><span class="pl40"></span>请求体类型</div>
                <div class="hh100 plr12 ptb14 bo-ce-1 flex4 bg-white flex-bc">
              ...
              <div class="flex-sc c4" v-for="(vv, ii) in v.paramsType==1?v.params1:v.params2" :key="ii">
                <div class="hh100 plr12 ptb14 bo-ce-1 flex1 flex-bs">
