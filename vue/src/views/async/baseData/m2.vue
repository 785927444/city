...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'flex1', show: true, align: 'center', key: 'name', name: '涉及的重点建设内容' }, 
    ...
    editFrom: [
      ...
      { required: false, editshow: 'none', name: '类型',     key: 'type', type: 'input' },
      { required: true,  editshow: true,   name: '建设内容', key: 'name', type: 'input' },
      { required: true,  editshow: true,   name: '量化单位', key: 'unit', type: 'input' },
      { required: false, editshow: true,  name: '排序',     key: 'orderd', type: 'input' },
    ],
    addItem: {},
    model: 't_task_content',
  })
