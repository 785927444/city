          ...
          <div class="ww100 bs bo-i16-1 relative rad8 project-card" @click.stop="onViewDetail(v)">
            ...
            <div class="ww100 flex-col p12 c6">
              ...
              <div class="ww100 flex-sc mt10">
                ...
                <div class="rad5 ptb5 plr12 cursor bgi1 white" @click.stop="toPath('/actionApply', {key: v.type, action: '019c041a-9f8c-7e9e-91eb-0ae051e6f324', id: v.id})">审批</div>
              </div>
            </div>
          </div>
        </div>
...
<script lang="ts" setup>
  ...
  const init = async(key) => {
    ...
    let field = ``
    let args = `apply_status='1' and reserve_status='0' and construct_main='${configStore.user.id}'`
