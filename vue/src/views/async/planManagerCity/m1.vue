      ...
      <div class="table flex-sc warp">
        <div class="ww25 cursor p8" v-for="(v, i) in state.list" :key="i">
          <div class="ww100 bs bo-i16-1 relative rad8">
            ...
            <div class="ww100 flex-col p12 c6" @click.stop="toPath('/schemePlanView', {id: v.id})">
              ...
              <div class="ww100 flex-sc mt10">
                ...
                <span>{{ v.datetime?v.datetime:'-' }}</span>
              </div>
              <div class="ww100 flex-sc mt10">
                <span class="w110">包含项目数</span>
                <span>{{ v.project_num?v.project_num:'-' }}</span>
              </div>
               <div class="ww100 flex-sc mt10">
                <span class="w110">重点任务数</span>
                <span>{{ v.task_num?v.task_num:'-' }}</span>
              </div>
              <div class="ww100 flex-sc mt10">
