          ...
          <div class="ww100 bs bo-i16-1 relative rad8 project-card" @click.stop="onViewDetail(v)">
            ...
            <div class="ww100 flex-col p12 c6">
              ...
              <div class="ww100 flex-sc mt10">
                ...
                <div class="rad5 ptb5 plr12 cursor bgi1 white" v-if="v.reserve_status>'0' && configStore.user.id == v.user_id" @click.stop="toPath('/actionApply', {key:'department', action: '1f10502a-e388-6850-8aa3-265c92863865', id: v.id})">更新进度</div>
              </div>
            </div>
          </div>
        </div>
...
<script lang="ts" setup>
  ...
  const init = async(key) => {
    ...
    let field = ``
    let args = `user_id='${configStore.user.id}' and user_role!='5'`
