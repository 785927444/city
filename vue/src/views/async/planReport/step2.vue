  ...
  <div class="layout-col">
    <div class="hh100 flex-col pplr15 hidden">
      ...
      <div class="ww100 flex-sc pt20 pb15 plr15">
        <div class="mr40 ptb10 f18 relative cursor actfont" :class="publicStore.current.value == v.value?'i1 bob-i1-2':'bob-tt-2'" v-for="(v, i) in activeTab" :key="i" @click.stop="publicStore.current = {...v}" >
      ...
      <!-- 列表 -->
      <div class="layout-col">
        <step21 v-if="publicStore.current.value=='1'" />
        <step22 v-if="publicStore.current.value=='2'" />
      </div>
    </div>
  </div>
</template>
