<template>
	<div id="mapContainer relative" class="mapContainer">
		<!-- 右上角功能按钮区 -->
		<div class="map-controls">
			<button class="bgi1" title="工具箱" :class="{ active: showToolbox }" @click="toggleToolbox">
			...
			try {
				...
				if (olMap) {
					...
					defaultDrawTool.addPolygon(coordinates, {
						fillColor: 'rgba(255, 0, 0, 0.2)', // 红色半透明填充
